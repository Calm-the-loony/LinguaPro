...
echo -e "  2. Импортируйте БД: ${YELLOW}./deploy/init-db.sh${NC}"
echo -e "  3. Запустите деплой: ${YELLOW}./deploy/deploy.sh${NC}"
echo -e "  4. SSL сертификат: ${YELLOW}./deploy/renew-ssl.sh init${NC}"
